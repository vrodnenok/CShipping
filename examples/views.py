...
from CShipping.utils import render_response
...
def maps(request):
	return render_response(request,'examples/google_map_example_page.html',{'GOOGLE_API_KEY':settings.GOOGLE_API_KEY})
...
def pagination_example(request):
	...
	return render_response(request,'examples/pagination_example.html',{'items':items})
...
def full_form_example(request):
	...
	return render_response(request,'examples/full_form_example.html',{'form':example_form})
